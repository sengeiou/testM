...
public class AudioMessage extends MessageEntity implements Serializable {
    ...
    public static AudioMessage parseFromDB(MessageEntity entity) {
        ...
        try {
            ...
            audioMessage.setAudioPath(extraContent.optString("audioPath"));
            audioMessage.setAudiolength(extraContent.optInt("audiolength"));
            audioMessage.setReadStatus(extraContent.optInt("readStatus"));
