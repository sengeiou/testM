 ...
 * describe:
 */
class DialogCommon_T constructor(context: Context, val titleText: String = "", val contentText: String = "",
                                 ...
                                 theme: Int = R.style.dialog_common_t) : AlertDialog(context, theme), DialogInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mDialogView = View.inflate(context, R.layout.view_dialog_layout_t, null)
