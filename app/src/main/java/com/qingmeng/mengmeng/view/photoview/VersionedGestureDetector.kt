...
internal abstract class VersionedGestureDetector {
    lateinit var mListener: OnGestureListener
    ...
    private class FroyoDetector(context: Context) : EclairDetector(context) {
        ...
        private val mScaleListener = object : OnScaleGestureListener {
    ...
    companion object {
        val LOG_TAG = "VersionedGestureDetector"
        ...
        fun newInstance(context: Context, listener: OnGestureListener): VersionedGestureDetector {
            ...
            detector = when {
                sdkVersion < Build.VERSION_CODES.ECLAIR -> CupcakeDetector(context)
                sdkVersion < Build.VERSION_CODES.FROYO -> EclairDetector(context)
                else -> FroyoDetector(context)
            }
