...
interface IPhotoView {
    ...
    /**
     * @return The current minimum scale level. What this value represents depends on the current [android.widget.ImageView.ScaleType].
     */
    /**
     * Sets the minimum scale level. What this value represents depends on the current [android.widget.ImageView.ScaleType].
     */
    var minScale: Float

    /**
     * @return The current middle scale level. What this value represents depends on the current [android.widget.ImageView.ScaleType].
     */
    /**
     * Sets the middle scale level. What this value represents depends on the current [android.widget.ImageView.ScaleType].
     */
    var midScale: Float

    /**
     * @return The current maximum scale level. What this value represents depends on the current [android.widget.ImageView.ScaleType].
     */
    /**
     * Sets the maximum scale level. What this value represents depends on the current [android.widget.ImageView.ScaleType].
     */
    var maxScale: Float
     ...
     * this [android.widget.ImageView.ScaleType].
     *
