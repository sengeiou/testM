package com.qingmeng.mengmeng.view.camera;
...
import com.qingmeng.mengmeng.activity.CameraActivity;
...
public class CameraManager implements ICameraHelper {
    ...
    private CameraManager(Context context) {
        ...
        mLightStatus = FlashLigthStatus.valueOf(SharedSingleton.Companion.getInstance().getInt(SP_LIGHT_STATUE, FlashLigthStatus.LIGHT_AUTO.ordinal())); //默认 自动
        mFlashDirection = CameraDirection.valueOf(SharedSingleton.Companion.getInstance().getInt(SP_CAMERA_DIRECTION, CameraDirection.CAMERA_BACK.ordinal())); //默认后置摄像头
    }
    ...
    public void setLightStatus(FlashLigthStatus mLightStatus) {
        ...
        if (m_tvFlashLight != null) {
            ...
            SharedSingleton.Companion.getInstance().setString(SP_LIGHT_STATUE, mLightStatus.ordinal() + "");
        }
    }
    ...
    public void setCameraDirection(CameraDirection mFlashDirection) {
        ...
        if (m_tvCameraDireation != null) {
            ...
            SharedSingleton.Companion.getInstance().setString(SP_CAMERA_DIRECTION, mFlashDirection.ordinal() + "");
